		...
		<fieldset>
			<label><h3>Name</h3></label></br>
			 <input type="text" name="name"
				id="FoodItem_name" size="55"></input> 
				
				
				<br> <label><h3>Image
					URL</h3></label></br> <input type="text" name="image" id="FoodItem_image" size="55"></input>
			
			
			
			<br> <label><h3>Description</h3></label></br> <input type="text"
				name="description" id="FoodItem_description" size="55"></input>
				 
				 
				 <br>
				 <label><h3>Price</h3></label></br> <input type="text" name="price"
				id="FoodItem_price" size="55"></input> <br>
			<br>
		</fieldset>
