...
public class OrderStatusesAdminServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<h1>Admin-Food Order Status</h1>");
		...
		if (order.size() == 0) {
			...
			for (Order newOrder : order) {
				out.println("<tr style=\"padding:1em;\">" + "<td style=\"padding:1em;\">" + "<h3>Name:</h3>"
						+ newOrder.getfoodItems().getName() + "</td>" + "<td style=\"padding:1em;\">" + "<h3>Price:</h3>"+"$"
						+ newOrder.getfoodItems().getprice() + "</td>" + "<td style=\"padding:1em;\">" + "<img src="
						+ newOrder.getfoodItems().getImageURL() + ">" + "</td>" + "<td style=\"padding:1em;\">"
						+ "<h3>Customer Name:</h3>" + newOrder.getcustName() + "</td>" + "<td style=\"padding:1em;\">"
						+ "<h3>Status:</h3>" + newOrder.getStatus() + "</td>" + "<td style=\"padding:1em;\">"
						+ "<h3>Date:</h3>" + newOrder.getdate() + "</td>" + "<td><a href='/GuestBook/admin/orders/edit?id="
		...
		out.println("</main>");
		out.println(
				"<a style=\"padding:1em; text-decoration: none;\" href='/GuestBook/admin/foods/'>Admin Menu</a>");
		out.println(
				"<a style=\"padding:1em; text-decoration: none;\" href='/GuestBook/menu'>Customer Menu</a>");
		out.println(
				"<a style=\"padding:1em; text-decoration: none;\" href='/GuestBook/orders'>Customer Order Status</a>");
