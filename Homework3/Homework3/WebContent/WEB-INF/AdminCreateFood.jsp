...
<body>
	...
	<form id="create_menu" method="post">
		...
		<fieldset>
			<label><h3>Name</h3></label></br> <input type="text" name="name"
				id="FoodItem_name" size="60"></input> <br> <label><h3>Image
					URL</h3></label></br> <input type="text" name="image" id="FoodItem_image" size="60"></input>
			<br> <label><h3>Description</h3></label></br> <input type="text"
				name="description" id="FoodItem_description" size="60"></input> <br>
			<label><h3>Price</h3></label></br> <input type="text" name="price"
				id="FoodItem_price" size="60"></input> <br>
			<br>
		</fieldset>
	...
	<h4>
		Go back to Admin-menu! <a
			href="http://localhost:8080/Homework3/RestaurantAdminServlet"
			class="link">
			<h4>Here</h4>
		</a>
	</h4>
